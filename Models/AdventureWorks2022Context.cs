...
namespace AdventureWorksServer.Models;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-8BCUTRO\\MSSQLSERVER1;Database=AdventureWorks2022;User Id=sa;Password=123;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BillOfMaterial>(entity =>
        {
            ...
            entity.ToTable("BillOfMaterials", "Production", tb =>
                {
                    tb.HasComment("Items required to make bicycles and bicycle subassemblies. It identifies the heirarchical relationship between a parent product and its components.");
                    tb.HasTrigger("MSmerge_del_F0710874A26F4444A8E57B7D05885A06");
                    tb.HasTrigger("MSmerge_ins_F0710874A26F4444A8E57B7D05885A06");
                    tb.HasTrigger("MSmerge_upd_F0710874A26F4444A8E57B7D05885A06");
                });
            ...
            entity.HasIndex(e => e.Rowguid, "MSmerge_index_837578022").IsUnique();
        ...
        modelBuilder.Entity<Location>(entity =>
        {
            ...
            entity.ToTable("Location", "Production", tb =>
                {
                    tb.HasComment("Product inventory and manufacturing locations.");
                    tb.HasTrigger("MSmerge_del_02E35DF1D81541EF8B6388E38C65D693");
                    tb.HasTrigger("MSmerge_ins_02E35DF1D81541EF8B6388E38C65D693");
                    tb.HasTrigger("MSmerge_upd_02E35DF1D81541EF8B6388E38C65D693");
                });

            entity.HasIndex(e => e.Name, "AK_Location_Name").IsUnique();

            entity.HasIndex(e => e.Rowguid, "MSmerge_index_1957582012").IsUnique();
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.ToTable("Product", "Production", tb =>
                {
                    tb.HasComment("Products sold or used in the manfacturing of sold products.");
                    tb.HasTrigger("MSmerge_del_CAEF3913FAAA4296944292C76877660A");
                    tb.HasTrigger("MSmerge_ins_CAEF3913FAAA4296944292C76877660A");
                    tb.HasTrigger("MSmerge_upd_CAEF3913FAAA4296944292C76877660A");
                });
        ...
        modelBuilder.Entity<ProductCategory>(entity =>
        {
            ...
            entity.ToTable("ProductCategory", "Production", tb =>
                {
                    tb.HasComment("High-level product categorization.");
                    tb.HasTrigger("MSmerge_del_1E78F8D391154E739322744521816A8C");
                    tb.HasTrigger("MSmerge_ins_1E78F8D391154E739322744521816A8C");
                    tb.HasTrigger("MSmerge_upd_1E78F8D391154E739322744521816A8C");
                });
        ...
        modelBuilder.Entity<ProductCostHistory>(entity =>
        {
            ...
            entity.ToTable("ProductCostHistory", "Production", tb =>
                {
                    tb.HasComment("Changes in the cost of a product over time.");
                    tb.HasTrigger("MSmerge_del_2C78046F6FA64CBFA3D1D3EDD2919F6D");
                    tb.HasTrigger("MSmerge_ins_2C78046F6FA64CBFA3D1D3EDD2919F6D");
                    tb.HasTrigger("MSmerge_upd_2C78046F6FA64CBFA3D1D3EDD2919F6D");
                });

            entity.HasIndex(e => e.Rowguid, "MSmerge_index_450100644").IsUnique();
        ...
        modelBuilder.Entity<ProductDescription>(entity =>
        {
            ...
            entity.ToTable("ProductDescription", "Production", tb =>
                {
                    tb.HasComment("Product descriptions in several languages.");
                    tb.HasTrigger("MSmerge_del_D45821AE6A95487EA054D8CCC3DADEAB");
                    tb.HasTrigger("MSmerge_ins_D45821AE6A95487EA054D8CCC3DADEAB");
                    tb.HasTrigger("MSmerge_upd_D45821AE6A95487EA054D8CCC3DADEAB");
                });
        ...
        modelBuilder.Entity<ProductInventory>(entity =>
        {
            ...
            entity.ToTable("ProductInventory", "Production", tb =>
                {
                    tb.HasComment("Product inventory information.");
                    tb.HasTrigger("MSmerge_del_5AA78A5FD6B34F2E8593A9B030407C55");
                    tb.HasTrigger("MSmerge_ins_5AA78A5FD6B34F2E8593A9B030407C55");
                    tb.HasTrigger("MSmerge_upd_5AA78A5FD6B34F2E8593A9B030407C55");
                });

            entity.HasIndex(e => e.Rowguid, "MSmerge_index_594101157").IsUnique();
        ...
        modelBuilder.Entity<ProductListPriceHistory>(entity =>
        {
            ...
            entity.ToTable("ProductListPriceHistory", "Production", tb =>
                {
                    tb.HasComment("Changes in the list price of a product over time.");
                    tb.HasTrigger("MSmerge_del_5283A0F73D43487CB8E8E39853805459");
                    tb.HasTrigger("MSmerge_ins_5283A0F73D43487CB8E8E39853805459");
                    tb.HasTrigger("MSmerge_upd_5283A0F73D43487CB8E8E39853805459");
                });

            entity.HasIndex(e => e.Rowguid, "MSmerge_index_690101499").IsUnique();
        ...
        modelBuilder.Entity<ProductPhoto>(entity =>
        {
            ...
            entity.ToTable("ProductPhoto", "Production", tb =>
                {
                    tb.HasComment("Product images.");
                    tb.HasTrigger("MSmerge_del_7E55E0656D5540E0A2CCB85D978F8734");
                    tb.HasTrigger("MSmerge_ins_7E55E0656D5540E0A2CCB85D978F8734");
                    tb.HasTrigger("MSmerge_upd_7E55E0656D5540E0A2CCB85D978F8734");
                });

            entity.HasIndex(e => e.Rowguid, "MSmerge_index_866102126").IsUnique();
        ...
        modelBuilder.Entity<ProductProductPhoto>(entity =>
        {
            ...
            entity.ToTable("ProductProductPhoto", "Production", tb =>
                {
                    tb.HasComment("Cross-reference table mapping products and product photos.");
                    tb.HasTrigger("MSmerge_del_BE2D37E470DC4BEF98D1A9122FCA74CC");
                    tb.HasTrigger("MSmerge_ins_BE2D37E470DC4BEF98D1A9122FCA74CC");
                    tb.HasTrigger("MSmerge_upd_BE2D37E470DC4BEF98D1A9122FCA74CC");
                });

            entity.HasIndex(e => e.Rowguid, "MSmerge_index_898102240").IsUnique();
        ...
        modelBuilder.Entity<ProductReview>(entity =>
        {
            ...
            entity.ToTable("ProductReview", "Production", tb =>
                {
                    tb.HasComment("Customer reviews of products they have purchased.");
                    tb.HasTrigger("MSmerge_del_EEFC30556DF4496CABE9C2F5E1AA4A47");
                    tb.HasTrigger("MSmerge_ins_EEFC30556DF4496CABE9C2F5E1AA4A47");
                    tb.HasTrigger("MSmerge_upd_EEFC30556DF4496CABE9C2F5E1AA4A47");
                });

            entity.HasIndex(e => new { e.ProductId, e.ReviewerName }, "IX_ProductReview_ProductID_Name");

            entity.HasIndex(e => e.Rowguid, "MSmerge_index_946102411").IsUnique();
        ...
        modelBuilder.Entity<ScrapReason>(entity =>
        {
            ...
            entity.ToTable("ScrapReason", "Production", tb =>
                {
                    tb.HasComment("Manufacturing failure reasons lookup table.");
                    tb.HasTrigger("MSmerge_del_71396404557C44A6B206963154D4F96C");
                    tb.HasTrigger("MSmerge_ins_71396404557C44A6B206963154D4F96C");
                    tb.HasTrigger("MSmerge_upd_71396404557C44A6B206963154D4F96C");
                });

            entity.HasIndex(e => e.Name, "AK_ScrapReason_Name").IsUnique();

            entity.HasIndex(e => e.Rowguid, "MSmerge_index_350624292").IsUnique();
        ...
        modelBuilder.Entity<TransactionHistory>(entity =>
        {
            ...
            entity.ToTable("TransactionHistory", "Production", tb =>
                {
                    tb.HasComment("Record of each purchase order, sales order, or work order transaction year to date.");
                    tb.HasTrigger("MSmerge_del_8D31F6EA1AEF40C9AA3A5E0F7FD47180");
                    tb.HasTrigger("MSmerge_ins_8D31F6EA1AEF40C9AA3A5E0F7FD47180");
                    tb.HasTrigger("MSmerge_upd_8D31F6EA1AEF40C9AA3A5E0F7FD47180");
                });
            ...
            entity.HasIndex(e => e.Rowguid, "MSmerge_index_910626287").IsUnique();
        ...
        modelBuilder.Entity<TransactionHistoryArchive>(entity =>
        {
            ...
            entity.ToTable("TransactionHistoryArchive", "Production", tb =>
                {
                    tb.HasComment("Transactions for previous years.");
                    tb.HasTrigger("MSmerge_del_03FB35009D9B41508E4948E192B9850A");
                    tb.HasTrigger("MSmerge_ins_03FB35009D9B41508E4948E192B9850A");
                    tb.HasTrigger("MSmerge_upd_03FB35009D9B41508E4948E192B9850A");
                });
            ...
            entity.HasIndex(e => e.Rowguid, "MSmerge_index_990626572").IsUnique();
        ...
        modelBuilder.Entity<UnitMeasure>(entity =>
        {
            ...
            entity.ToTable("UnitMeasure", "Production", tb =>
                {
                    tb.HasComment("Unit of measure lookup table.");
                    tb.HasTrigger("MSmerge_del_79B312CB3BE04DBEBC9994881F141F84");
                    tb.HasTrigger("MSmerge_ins_79B312CB3BE04DBEBC9994881F141F84");
                    tb.HasTrigger("MSmerge_upd_79B312CB3BE04DBEBC9994881F141F84");
                });

            entity.HasIndex(e => e.Name, "AK_UnitMeasure_Name").IsUnique();

            entity.HasIndex(e => e.Rowguid, "MSmerge_index_1070626857").IsUnique();
        ...
        modelBuilder.Entity<WorkOrder>(entity =>
        {
            ...
            entity.ToTable("WorkOrder", "Production", tb =>
                {
                    ...
                    tb.HasTrigger("MSmerge_del_7740B9644CF44609BCDAD9F254AADFD3");
                    tb.HasTrigger("MSmerge_ins_7740B9644CF44609BCDAD9F254AADFD3");
                    tb.HasTrigger("MSmerge_upd_7740B9644CF44609BCDAD9F254AADFD3");
            ...
            entity.HasIndex(e => e.Rowguid, "MSmerge_index_1182627256").IsUnique();
        ...
        modelBuilder.Entity<WorkOrderRouting>(entity =>
        {
            ...
            entity.ToTable("WorkOrderRouting", "Production", tb =>
                {
                    tb.HasComment("Work order details.");
                    tb.HasTrigger("MSmerge_del_D758EB8EF26840C3A0F21C67735CE267");
                    tb.HasTrigger("MSmerge_ins_D758EB8EF26840C3A0F21C67735CE267");
                    tb.HasTrigger("MSmerge_upd_D758EB8EF26840C3A0F21C67735CE267");
                });

            entity.HasIndex(e => e.ProductId, "IX_WorkOrderRouting_ProductID");

            entity.HasIndex(e => e.Rowguid, "MSmerge_index_1262627541").IsUnique();
